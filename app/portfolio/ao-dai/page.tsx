...
const staticCategory = portfolioCategories.find((c) => c.id === "ao-dai")!;

export const metadata: Metadata = {
  title: "Áo Dài Photography",
  description:
    "Vietnamese traditional Áo Dài fine-art photography. Timeless elegance captured in cinematic light.",
  openGraph: { images: [{ url: staticCategory.heroImage }] },
};

export default async function AoDaiPage() {
  const [dbPhotos, dbHero] = await Promise.all([
    getPhotosByCategory("ao-dai"),
    getCategoryHeroImage("ao-dai"),
  ]);
