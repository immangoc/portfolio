...
const staticCategory = portfolioCategories.find((c) => c.id === "concept")!;

export const metadata: Metadata = {
  title: "Nàng Thơ — Concept Photography",
  description:
    "Dreamy conceptual fine-art portraits. Vietnamese muse photography where poetry meets light.",
  openGraph: { images: [{ url: staticCategory.heroImage }] },
};

export default async function ConceptPage() {
  const [dbPhotos, dbHero] = await Promise.all([
    getPhotosByCategory("concept"),
    getCategoryHeroImage("concept"),
  ]);
